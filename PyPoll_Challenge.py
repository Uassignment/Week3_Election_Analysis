...
with open(file_to_save, "w") as txt_file:
    ...
    for name in county_votes:
        ...
        county_total = county_votes[name]
        # 6c: Calculate the percentage of votes for the county.
        percent = (county_total / float(total_votes)) * 100  
        county_results = (
            f"{name}: {percent:.1f}% ({county_total:,})\n")
        ...
        if county_total > largest_county_voter_turnout:
            largest_county_voter_turnout = county_total
            largest_county = name
